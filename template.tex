...
\and
\IEEEauthorblockN{3\textsuperscript{rd} Philipp Witte}
\IEEEauthorblockA{\textit{Georgia Institute of Technology}}
\and
\IEEEauthorblockN{5\textsuperscript{th} Rhodri Nelson}
\IEEEauthorblockA{\textit{Imperial College London}}
\and
\IEEEauthorblockN{6\textsuperscript{th} George Bisbas}
\IEEEauthorblockA{\textit{Imperial College London}}
\and
\IEEEauthorblockN{6\textsuperscript{th} Felix J. Herrmann}
\IEEEauthorblockA{\textit{Georgia Institute of Technology}}
\and
\IEEEauthorblockN{6\textsuperscript{th} Geragd J. Gorman}
\IEEEauthorblockA{\textit{Imperial College London}}
\and
