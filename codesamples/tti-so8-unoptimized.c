...
void bf0(struct dataobj *restrict damp_vec, const float dt, struct dataobj *restrict epsilon_vec, float *restrict r49_vec, float *restrict r50_vec, float *restrict r51_vec, float *restrict r52_vec, float *restrict r53_vec, struct dataobj *restrict u_vec, struct dataobj *restrict v_vec, struct dataobj *restrict vp_vec, const int x0_blk0_size, const int x_size, const int y0_blk0_size, const int y_size, const int z_size, const int t0, const int t1, const int t2, const int x_M, const int x_m, const int y_M, const int y_m, const int z_M, const int z_m, const int nthreads)
{
  ...
  float (*restrict v)[v_vec->size[1]][v_vec->size[2]][v_vec->size[3]] __attribute__ ((aligned (64))) = (float (*)[v_vec->size[1]][v_vec->size[2]][v_vec->size[3]]) v_vec->data;
  float (*restrict vp)[vp_vec->size[1]][vp_vec->size[2]] __attribute__ ((aligned (64))) = (float (*)[vp_vec->size[1]][vp_vec->size[2]]) vp_vec->data;
  float r98[x0_blk0_size + 2 + 2][y0_blk0_size + 2 + 2][z_size + 2 + 2] __attribute__((aligned(64)));
  float r99[x0_blk0_size + 2 + 2][y0_blk0_size + 2 + 2][z_size + 2 + 2] __attribute__((aligned(64)));
  if (x0_blk0_size == 0)
  {
    return;
  }
  #pragma omp parallel num_threads(nthreads) private(r98,r99)
  {
    #pragma omp for collapse(1) schedule(dynamic,1)
      ...
      for (int y0_blk0 = y_m; y0_blk0 <= y_M; y0_blk0 += y0_blk0_size)
      {
        for (int x = x0_blk0 - 2, xs = 0; x <= x0_blk0 + x0_blk0_size + 1; x += 1, xs += 1)
        {
          for (int y = y0_blk0 - 2, ys = 0; y <= y0_blk0 + y0_blk0_size + 1; y += 1, ys += 1)
          {
            ...
            for (int z = z_m - 2; z <= z_M + 2; z += 1)
            {
              r98[xs][ys][z + 2] = -(8.33333346e-3F*(u[t0][x + 6][y + 8][z + 8] - u[t0][x + 10][y + 8][z + 8]) + 6.66666677e-2F*(-u[t0][x + 7][y + 8][z + 8] + u[t0][x + 9][y + 8][z + 8]))*r51[x + 2][y + 2][z + 2]*r52[x + 2][y + 2][z + 2] - (8.33333346e-3F*(u[t0][x + 8][y + 6][z + 8] - u[t0][x + 8][y + 10][z + 8]) + 6.66666677e-2F*(-u[t0][x + 8][y + 7][z + 8] + u[t0][x + 8][y + 9][z + 8]))*r52[x + 2][y + 2][z + 2]*r53[x + 2][y + 2][z + 2] - (8.33333346e-3F*(u[t0][x + 8][y + 8][z + 6] - u[t0][x + 8][y + 8][z + 10]) + 6.66666677e-2F*(-u[t0][x + 8][y + 8][z + 7] + u[t0][x + 8][y + 8][z + 9]))*r50[x + 2][y + 2][z + 2];
              r99[xs][ys][z + 2] = -(8.33333346e-3F*(v[t0][x + 6][y + 8][z + 8] - v[t0][x + 10][y + 8][z + 8]) + 6.66666677e-2F*(-v[t0][x + 7][y + 8][z + 8] + v[t0][x + 9][y + 8][z + 8]))*r51[x + 2][y + 2][z + 2]*r52[x + 2][y + 2][z + 2] - (8.33333346e-3F*(v[t0][x + 8][y + 6][z + 8] - v[t0][x + 8][y + 10][z + 8]) + 6.66666677e-2F*(-v[t0][x + 8][y + 7][z + 8] + v[t0][x + 8][y + 9][z + 8]))*r52[x + 2][y + 2][z + 2]*r53[x + 2][y + 2][z + 2] - (8.33333346e-3F*(v[t0][x + 8][y + 8][z + 6] - v[t0][x + 8][y + 8][z + 10]) + 6.66666677e-2F*(-v[t0][x + 8][y + 8][z + 7] + v[t0][x + 8][y + 8][z + 9]))*r50[x + 2][y + 2][z + 2];
            }
          }
        }
        for (int x = x0_blk0, xs = 0; x <= x0_blk0 + x0_blk0_size - 1; x += 1, xs += 1)
        {
          for (int y = y0_blk0, ys = 0; y <= y0_blk0 + y0_blk0_size - 1; y += 1, ys += 1)
          {
            ...
            {
              float r111 = dt*dt;
              float r110 = dt*damp[x + 1][y + 1][z + 1];
              float r109 = r50[x + 2][y + 2][z + 1]*r99[xs + 2][ys + 2][z + 1] - r50[x + 2][y + 2][z + 3]*r99[xs + 2][ys + 2][z + 3] + r51[x + 1][y + 2][z + 2]*r52[x + 1][y + 2][z + 2]*r99[xs + 1][ys + 2][z + 2] - r51[x + 3][y + 2][z + 2]*r52[x + 3][y + 2][z + 2]*r99[xs + 3][ys + 2][z + 2] + r52[x + 2][y + 1][z + 2]*r53[x + 2][y + 1][z + 2]*r99[xs + 2][ys + 1][z + 2] - r52[x + 2][y + 3][z + 2]*r53[x + 2][y + 3][z + 2]*r99[xs + 2][ys + 3][z + 2];
              float r108 = -r50[x + 2][y + 2][z]*r99[xs + 2][ys + 2][z] + r50[x + 2][y + 2][z + 4]*r99[xs + 2][ys + 2][z + 4] - r51[x][y + 2][z + 2]*r52[x][y + 2][z + 2]*r99[xs][ys + 2][z + 2] + r51[x + 4][y + 2][z + 2]*r52[x + 4][y + 2][z + 2]*r99[xs + 4][ys + 2][z + 2] - r52[x + 2][y][z + 2]*r53[x + 2][y][z + 2]*r99[xs + 2][ys][z + 2] + r52[x + 2][y + 4][z + 2]*r53[x + 2][y + 4][z + 2]*r99[xs + 2][ys + 4][z + 2];
              float r107 = 1.0/(vp[x + 8][y + 8][z + 8]*vp[x + 8][y + 8][z + 8]);
              float r106 = -2.0F*r107 + r110;
              float r105 = 8.33333346e-3F*(r50[x + 2][y + 2][z]*r98[xs + 2][ys + 2][z] - r50[x + 2][y + 2][z + 4]*r98[xs + 2][ys + 2][z + 4] + r51[x][y + 2][z + 2]*r52[x][y + 2][z + 2]*r98[xs][ys + 2][z + 2] - r51[x + 4][y + 2][z + 2]*r52[x + 4][y + 2][z + 2]*r98[xs + 4][ys + 2][z + 2] + r52[x + 2][y][z + 2]*r53[x + 2][y][z + 2]*r98[xs + 2][ys][z + 2] - r52[x + 2][y + 4][z + 2]*r53[x + 2][y + 4][z + 2]*r98[xs + 2][ys + 4][z + 2]) + 6.66666677e-2F*(-r50[x + 2][y + 2][z + 1]*r98[xs + 2][ys + 2][z + 1] + r50[x + 2][y + 2][z + 3]*r98[xs + 2][ys + 2][z + 3] - r51[x + 1][y + 2][z + 2]*r52[x + 1][y + 2][z + 2]*r98[xs + 1][ys + 2][z + 2] + r51[x + 3][y + 2][z + 2]*r52[x + 3][y + 2][z + 2]*r98[xs + 3][ys + 2][z + 2] - r52[x + 2][y + 1][z + 2]*r53[x + 2][y + 1][z + 2]*r98[xs + 2][ys + 1][z + 2] + r52[x + 2][y + 3][z + 2]*r53[x + 2][y + 3][z + 2]*r98[xs + 2][ys + 3][z + 2]) - 1.78571425e-5F*(u[t0][x + 4][y + 8][z + 8] + u[t0][x + 8][y + 4][z + 8] + u[t0][x + 8][y + 8][z + 4] + u[t0][x + 8][y + 8][z + 12] + u[t0][x + 8][y + 12][z + 8] + u[t0][x + 12][y + 8][z + 8]) + 2.53968248e-4F*(u[t0][x + 5][y + 8][z + 8] + u[t0][x + 8][y + 5][z + 8] + u[t0][x + 8][y + 8][z + 5] + u[t0][x + 8][y + 8][z + 11] + u[t0][x + 8][y + 11][z + 8] + u[t0][x + 11][y + 8][z + 8]) - 1.99999996e-3F*(u[t0][x + 6][y + 8][z + 8] + u[t0][x + 8][y + 6][z + 8] + u[t0][x + 8][y + 8][z + 6] + u[t0][x + 8][y + 8][z + 10] + u[t0][x + 8][y + 10][z + 8] + u[t0][x + 10][y + 8][z + 8]) + 1.59999996e-2F*(u[t0][x + 7][y + 8][z + 8] + u[t0][x + 8][y + 7][z + 8] + u[t0][x + 8][y + 8][z + 7] + u[t0][x + 8][y + 8][z + 9] + u[t0][x + 8][y + 9][z + 8] + u[t0][x + 9][y + 8][z + 8]) - 8.54166647e-2F*u[t0][x + 8][y + 8][z + 8];
              float r95 = r106*u[t2][x + 8][y + 8][z + 8] + r107*(4.0F*u[t0][x + 8][y + 8][z + 8]);
              float r96 = 1.0F/(2.0F*r107 + r110);
              float r97 = r106*v[t2][x + 8][y + 8][z + 8] + r107*(4.0F*v[t0][x + 8][y + 8][z + 8]);
              u[t1][x + 8][y + 8][z + 8] = r96*(r111*(2.0F*(r105*(2*epsilon[x + 8][y + 8][z + 8] + 1) + (8.33333346e-3F*r108 + 6.66666677e-2F*r109)*r49[x + 2][y + 2][z + 2])) + r95);
              v[t1][x + 8][y + 8][z + 8] = r96*(r111*(2.0F*r105*r49[x + 2][y + 2][z + 2] + 1.66666669138067e-2F*r108 + 1.33333335310454e-1F*r109) + r97);
            }
          }
        }
      }
