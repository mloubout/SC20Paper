...
\textcolor{red}{We highlight the main features of the distributed framework tha enable the industry scale
applications we describe in this paper. A more thorough study of its implementation, including `mpi4numpy' and
a complete scaling analysis will be presented in a later paper. Initial results assciated with early version of \devito's
