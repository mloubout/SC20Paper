...
\begin{python}
from\href{https://github.com/devitocodes/devito}{Devito}import Grid
...
\begin{python}
from\href{https://github.com/devitocodes/devito}{Devito}import Function, TimeFunction
...
\begin{python}
from\href{https://github.com/devitocodes/devito}{Devito}import SparseTimeFunction
...
\begin{python}
from\href{https://github.com/devitocodes/devito}{Devito}import solve, Eq, Operator
...
\begin{python}
from\href{https://github.com/devitocodes/devito}{Devito}import Operator
...
can also be easily run on a traditional HPC cluster environment using.
...
The extended\href{https://github.com/devitocodes/devito}{Devito}language introduces two new types,
...
component of a tensorial object -- a (scalar)\href{https://github.com/devitocodes/devito}{Devito}\texttt{Function} --
...
\begin{python}
from\href{https://github.com/devitocodes/devito}{Devito}import VectorTimeFunction,
                   TensorTimeFunction
...
computational portability and efficiency through the\href{https://github.com/devitocodes/devito}{Devito}compiler. The
complete generated code for the elastic wave-equation with and without MPI
is made available at
\href{https://github.com/mloubout/SC20Paper/tree/master/gencode}{CodeSample}
in \texttt{elastic-so12.c} and \texttt{elastic-so8-mpi.c}.
