...
It is up to the Devito compiler to translate the symbolic specification
...
In this section we illustrate the Devito language showing how to implement
...
However, it can be found in the Devito tutorial on elastic modelling
on GitHub.}\label{PrettyElas}
\end{figure*}
...
analysis, we also compared the runtime of Devito with a reference
...
the beginning, Devito provides the scalability necessary. First, we showed
