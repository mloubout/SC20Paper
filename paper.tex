...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Scaling through abstractions – high-performance vectorial wave simulations for seismic inversion with Devito},
            colorlinks=true,
            citecolor=black,
            urlcolor=blue,
            linkcolor=black,
...
\begin{python}[label=sparse, caption=SparseFunction deifnition]
...
for three dimensional problems and this comparison will be part of future
work.

\section{Conclusions}\label{conclusions}

The transition from academic size problems, such as the two-dimensional
acoustic wave-equation, to real-world applications can be challenging in
...
The code to reproduce the different examples presented in this work is available online in the follwing repositories:
...
\begin{itemize}
  ...
  and can be run with any size and spatial order. A standalone script to run the large 3D elastic modeling
